...
class SobolevMetric(BaseMetric):
    ...
    def exact_sobolev(
        ...
        *,
        ...
        """Computes the Sobolev metric exactly for a single sample.
    ...
    def _sobolev_from_directions(
        ...
        *,
        ...
        """Computes the Sobolev metric for a single sample in several directions.
    ...
    def interpolated_sobolev(
        ...
        *,
        ...
        """Compute Sobolev metric for a single sample by propagating a higher order Taylor polynomial.
        ...
        return self._sobolev_from_directions(
    ...
    def stochastic_sobolev(
        ...
        *,
        ...
        """Computes the stochastic Sobolev metric.
        ...
        return self._sobolev_from_directions(
            model, x=x, target=target, directions=random_vectors
        )
