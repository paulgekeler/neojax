...
def is_learnable_metric_weight(metric: PyTree) -> PyTree:
    ...
    !!! info    "Usage with `ComposedMetric`"
        This function respects the flags of composed metric instances under
        `ComposedMetric`. The `ComposedMetric.learnable_weight` flag doesn`t
        overwrite flags of other metrics.
